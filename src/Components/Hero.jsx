...
export default function Hero() {
  return (
    <div className="relative min-h-[calc(100vh-80px)] overflow-hidden flex items-center justify-center">
      ...
      <div className="relative isolate px-6 lg:px-8 flex items-center justify-center h-full">
        <div className="max-w-2xl text-center rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl shadow-2xl px-8 py-20 sm:px-12 space-y-6">
          <Reveal
            as="h1"
            className="text-5xl font-semibold tracking-tight text-white sm:text-7xl text-shimmer"
          >
