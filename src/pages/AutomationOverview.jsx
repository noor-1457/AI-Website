      ...
      <section className="bg-gray-900 text-gray-300 py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {/* <!-- Card 2 --> */}
            <Reveal className="bg-gray-900 rounded-2xl p-8 hover:shadow-lg transition" delay={120}>
            ...
            {/* <!-- Card 3 --> */}
            <Reveal className="bg-gray-900 rounded-2xl p-8 hover:shadow-lg transition" delay={200}>
              <div className="text-indigo-500 text-3xl mb-4">📈</div>
              <h3 className="text-xl font-semibold text-white mb-3">
                Scalable Growth
              </h3>
